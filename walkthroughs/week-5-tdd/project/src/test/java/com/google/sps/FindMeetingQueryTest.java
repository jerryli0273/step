...
public final class FindMeetingQueryTest {
  ...
  public void eventSplitsRestriction() {
    // The event should split the day into two options 
  ...
  @Test
  public void OptionalAttendeeIsConsideredNotAvailable() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event3", TimeRange.WHOLE_DAY,
  ...
  @Test
  public void OptionalAttendeeIsConsideredLimitedAvailable() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event3", TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_C)));
  ...
  @Test
  public void OptionalCodingChallenge1() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event3", TimeRange.WHOLE_DAY,
            Arrays.asList(PERSON_C)),
        new Event("Event 4", TimeRange.fromStartDuration(TIME_0800AM, DURATION_60_MINUTES),
  ...
  @Test
  public void OptionalCodingChallenge2() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--A--|
